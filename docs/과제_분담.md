...
> 설계서(`DESIGN_DOCUMENT.md`)의 팀 구성 및 역할을 기반으로 작성되었습니다.  
...
#### 보고서 작성
- [ ] 양심 서약서 작성 (1페이지)
- [ ] 보고서 표지 작성 (과제 제목, 제출 날짜, 팀 명칭, 작성자 및 역할 명시)
- [ ] 최종 시스템 설계 부분 작성 (아키텍처 다이어그램, Lambda 함수 구조, API Gateway 구조)
- [ ] Lambda + API Gateway 구현 결과 작성 (전체 구조 설명, 인증 시스템 설명)
- [ ] 보고서 전체 통합
- [ ] 보고서 최종 검토
...
#### 보고서 작성
- [ ] 데이터 서비스 구현 결과 작성 (CrowdService, SubwayService, ParkingService 구현 내용)
- [ ] MongoDB Atlas 마이그레이션 내용 작성
- [ ] ElastiCache 설정 내용 작성
- [ ] 소스코드 정리 (데이터 처리 Lambda 함수)
- [ ] 공공데이터 API 연동 내용 작성

#### PPT 발표자료
- [ ] 데이터 처리 부분 슬라이드 작성
- [ ] DB 마이그레이션 슬라이드 작성
- [ ] 공공데이터 API 연동 슬라이드 작성
...
#### 보고서 작성
- [ ] Ranking, Area 서비스 구현 결과 작성
- [ ] Lambda Layer 구조 설명 작성
- [ ] 소스코드 정리 (보조 함수, 공통 코드)
- [ ] 구현 완료/미완료 서비스 구분 정리
  - [ ] 완료된 서비스 목록
  - [ ] 미완료 서비스 목록 (있는 경우)
...
#### 프론트엔드 준비
- [ ] 현재 프론트엔드 API 호출 코드 확인
- [ ] API 엔드포인트 목록 정리
- [ ] 환경 변수 파일 확인 (.env)
- [ ] API Gateway 엔드포인트로 변경할 위치 파악

#### 프론트엔드 연동
- [ ] API Gateway 엔드포인트 URL 확인
- [ ] 프론트엔드 API 클라이언트 수정 (API Gateway URL로 변경)
...
### 보고서
- [ ] 양심 서약서
- [ ] 보고서 표지 (과제 제목, 제출 날짜, 팀 명칭, 작성자 및 역할)
- [ ] 최종 시스템 설계
- [ ] 구현 결과 (소스코드 설명)
- [ ] 완료/미완료 서비스 구분
- [ ] 서비스 화면 캡처
