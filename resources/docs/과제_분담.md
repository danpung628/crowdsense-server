...
- [ ] ElastiCache 클러스터 생성 (Redis) - 목업 Redis 사용 중
...
#### Lambda 함수 구현 - 서비스 (6개) ⚠️ **부분 완료 (하드코딩)**
- [x] `ranking-popular`: 인기 장소 랭킹 Lambda 함수 구현 (하드코딩 데이터, 작동 중)
